...
courseText = open('../Scraped_Text/' + weekly + '_Coursera_Text.txt').read()
...
wordList = []
f = open('../Text_Output/FreqDist_' + weekly + '.txt', "w")
